...
/** @group Errors */
export class SdkError extends JuError {
...
export class OperationHandlerMissingError extends SdkError {
  ...
  constructor(operationKey: string) {
    const message =
      ...
      `"ju.operations().register(operation, operationHandler)".`;
    super(message);
  }
}
...
export class OperationUnauthorizedForGuestsError extends SdkError {
  ...
  constructor(operation: string) {
    const message =
      ...
      `For instance, by using "ju.use(walletAdapterIdentity(wallet))" or ` +
...
export class ProgramNotRecognizedError extends SdkError {
  ...
  constructor(nameOrAddress: string | PublicKey, cluster: Cluster) {
    ...
    const message =
      ...
      'If so, you may use "ju.programs().register(myProgram)" to fix this.';
    super(message);
