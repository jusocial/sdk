...
export type OperationOptions = {
   ...
   * `ju.rpc.setDefaultFeePayer(payer)`.
   *
   * @defaultValue `ju.rpc().getDefaultFeePayer()`
   */
  payer?: Signer;
   ...
   * await ju.app().findProfileByAddress(input, { signal: abortController.signal });
   * ```
   *
...
export const makeConfirmOptionsFinalizedOnMainnet = (
  ...
  return ju.cluster === 'mainnet-beta'
